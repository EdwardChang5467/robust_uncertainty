...
parser.add_argument('--model_path', type=str, help='model path',default="/data/linqinhong/model/llama-2-7b-chat-hf")
# parser.add_argument("--output_path", required=True, type=str, help="save path")
